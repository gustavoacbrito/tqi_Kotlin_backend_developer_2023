...
class CartController(private val cartService: CartService) {
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "200", description = "Operation sucessful")]
    )
    ...
    @ApiResponses(
        value = [ApiResponse(
            responseCode = "201",
            description = "Cart created sucessfully"
    ...
    fun create(@RequestBody cartDTO: CartDto): ResponseEntity<CartDto> {
        ...
        val location = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(cart.id).toUri()
    ...
    @ApiResponses(
        ...
        ), ApiResponse(responseCode = "404", description = "Cart not found"), ApiResponse(
            responseCode = "422",
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "204", description = "Product removed to the cart"), ApiResponse(
            responseCode = "404",
